...
class SystemWarning(SerializerMixin, Base):
    # 시스템에서 오는 이벤트들, ISR, DPC, Throttling
    __tablename__ = "system_warning"
    ...
    hardware_id_event_code_warned_idx = Index("hardware_id_smart_code_warned_idx", hardware_id, event_code, warned)